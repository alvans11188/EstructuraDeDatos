/*2.8 ELIMINAR EL PRIMER NODO DE LA LISTA
1-Verificar si la lista esta vacia
2- al momento de eliminar poner lista vacia (caso especial) o algun mensaje que indique que la lista se elimino algo y quedo vacia
*/
#include<iostream>
using namespace std;
